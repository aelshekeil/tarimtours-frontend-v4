-- Admin Users Management System - Final Cloud Setup
-- Skip enum creation and use existing role column approach

-- Step 1: Add columns to profiles table (skip if already exist)
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS role text DEFAULT 'user' NOT NULL CHECK (role IN ('user', 'admin', 'super_admin', 'editor', 'viewer')),
...
-- Step 2: Create admin policies for profiles table
...
-- Step 3: Create admin users view
...
-- Step 8: Make yourself super admin (replace with your email)
