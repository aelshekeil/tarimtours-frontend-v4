...
const Hero: React.FC = () => {
  ...
  const services = [
    ...
    { name: t('hero.esim_solutions'), route: '/esim-shop' }
  ];
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-1000"></div>
        <div className="absolute bottom-32 left-1/4 w-28 h-28 bg-blue-600 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-2000"></div>
            ...
            <div className={`transform transition-all duration-1000 delay-700 ${
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button 
                  ...
                  className="group relative bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center justify-center space-x-3"
                >
