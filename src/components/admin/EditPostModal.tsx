...
import cmsAPI, { Post, CreatePostData } from '../../services/cmsAPI';
...
const EditPostModal: React.FC<EditPostModalProps> = ({ post, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await cmsAPI.updatePost(post.id, submitData);
      onSuccess();
    } catch (error) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-md">
            <h4 className="text-sm font-medium text-gray-900 mb-2">Post Information</h4>
            <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
              ...
              {post.author_name && (
                <div>
                  <span className="font-medium">Author:</span> {post.author_name}
                </div>
              )}
            </div>
          </div>
